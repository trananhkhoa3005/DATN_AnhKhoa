        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <a href="{{ route('admin.sanpham') }}"><button class="btn btn-danger" type="button" style="float: right;">Quay về</button></a>
                ...
                <div class="x_content">
                    ...
                    <form method="post" action="{{ route('admin.XLThemSP') }}" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input name="txt_tensp" type="text" id="name" required="required"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input name="mota" type="text" id="name" required="required"
                                    class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input name="dongia" type="text" id="name" required="required"
                                    class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea name="ghichu" id="description"></textarea>
                            </div>
                        </div>
